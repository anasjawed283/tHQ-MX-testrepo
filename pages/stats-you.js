...
const StatsYou = (props) => {
  return (
    <>
      <div className="stats-you-container">
        <Head>
          <title>StatsYou - cyberX</title>
          <meta property="og:title" content="StatsYou - cyberX" />
        </Head>
        <div className="stats-you-testimonial"></div>
        <Header></Header>
        <div className="stats-you-container01">
          <div className="stats-you-container02">
            <h1 className="stats-you-text">Stats and Graphs </h1>
            <svg viewBox="0 0 1024 1024" className="stats-you-icon">
          ...
          <svg viewBox="0 0 1024 1024" className="stats-you-icon2">
            <path d="M1013.8 307.2c0 0-10-70.6-40.8-101.6-39-40.8-82.6-41-102.6-43.4-143.2-10.4-358.2-10.4-358.2-10.4h-0.4c0 0-215 0-358.2 10.4-20 2.4-63.6 2.6-102.6 43.4-30.8 31-40.6 101.6-40.6 101.6s-10.2 82.8-10.2 165.8v77.6c0 82.8 10.2 165.8 10.2 165.8s10 70.6 40.6 101.6c39 40.8 90.2 39.4 113 43.8 82 7.8 348.2 10.2 348.2 10.2s215.2-0.4 358.4-10.6c20-2.4 63.6-2.6 102.6-43.4 30.8-31 40.8-101.6 40.8-101.6s10.2-82.8 10.2-165.8v-77.6c-0.2-82.8-10.4-165.8-10.4-165.8zM406.2 644.8v-287.8l276.6 144.4-276.6 143.4z"></path>
          </svg>
        </div>
        <BarOfPie></BarOfPie>
        <div className="stats-you-pricing"></div>
        <div className="stats-you-container03">
          <div className="stats-you-container04">
            <div className="stats-you-container05">
              <h1 className="stats-you-text1">Sentiment scale</h1>
            </div>
            <div className="stats-you-container06">
              <h1 className="stats-you-text2">-ve</h1>
              <Scale></Scale>
              <h1 className="stats-you-text3">+ve</h1>
            </div>
          </div>
          <div className="stats-you-container07">
            <h1 className="stats-you-text4">Sentiment scale</h1>
          </div>
        </div>
        <div className="stats-you-blog">
          <div className="stats-you-container08">
            <BlogPostCard21
              text="😕"
              author="Ndtv"
          ...
          <div className="stats-you-container09">
            <BlogPostCard21
              text="🙂"
      ...
      <style jsx>
        {`
          ...
          .stats-you-container03 {
            flex: 0 0 auto;
            width: 100%;
            display: flex;
            align-items: flex-start;
          }
          .stats-you-container04 {
            flex: 0 0 auto;
            width: 100%;
            height: auto;
            display: flex;
