...
const StatsQuora = (props) => {
  return (
    <>
      <div className="stats-quora-container">
        <Head>
          <title>StatsQuora - cyberX</title>
          <meta property="og:title" content="StatsQuora - cyberX" />
        </Head>
        <div className="stats-quora-testimonial"></div>
        <Header></Header>
        <div className="stats-quora-container01">
          <div className="stats-quora-container02">
            <h1 className="stats-quora-text">Stats and Graphs </h1>
            <svg viewBox="0 0 1024 1024" className="stats-quora-icon">
        ...
        <BarOfPie></BarOfPie>
        <div className="stats-quora-pricing"></div>
        <div className="stats-quora-container03">
          <div className="stats-quora-container04">
            <div className="stats-quora-container05">
              <h1 className="stats-quora-text1">Sentiment scale</h1>
            </div>
            <div className="stats-quora-container06">
              <h1 className="stats-quora-text2">-ve</h1>
              <div className="stats-quora-container07">
                <div className="stats-quora-container08">
                  <div className="stats-quora-container09">
                    <h1>😡😠☹️😕    😐    🙂</h1>
                  </div>
                  <div className="stats-quora-container10">
                    <div className="stats-quora-container11">
                      <div className="stats-quora-container12">
                        <div className="stats-quora-container13">
                          <div className="stats-quora-container14">
                            <div className="stats-quora-container15">
                              <div className="stats-quora-container16">
                                <div className="stats-quora-container17">
                                  <div className="stats-quora-container18">
                                    <div className="stats-quora-container19">
                                      <div className="stats-quora-container20">
                                        <svg
                                          viewBox="0 0 1024 1024"
                                          className="stats-quora-icon04"
                                        >
                                          <path d="M832 406q44 0 75 31t31 75-31 75-75 31q-72 0-98-64h-124q-26 64-98 64t-98-64h-124q-26 64-98 64-44 0-75-31t-31-75 31-75 75-31q72 0 98 64h124q26-64 98-64t98 64h124q26-64 98-64z"></path>
                                        </svg>
                                        <svg
                                          viewBox="0 0 1024 1024"
                                          className="stats-quora-icon06"
                                        >
                                          <path d="M832 406q44 0 75 31t31 75-31 75-75 31q-72 0-98-64h-124q-26 64-98 64t-98-64h-124q-26 64-98 64-44 0-75-31t-31-75 31-75 75-31q72 0 98 64h124q26-64 98-64t98 64h124q26-64 98-64z"></path>
                                        </svg>
                                      </div>
                      ...
                      <svg
                        viewBox="0 0 1024 1024"
                        className="stats-quora-icon24"
                      >
                        <path d="M832 406q44 0 75 31t31 75-31 75-75 31q-72 0-98-64h-124q-26 64-98 64t-98-64h-124q-26 64-98 64-44 0-75-31t-31-75 31-75 75-31q72 0 98 64h124q26-64 98-64t98 64h124q26-64 98-64z"></path>
                      </svg>
                    </div>
                    <svg viewBox="0 0 1024 1024" className="stats-quora-icon26">
                      <path d="M832 406q44 0 75 31t31 75-31 75-75 31q-72 0-98-64h-124q-26 64-98 64t-98-64h-124q-26 64-98 64-44 0-75-31t-31-75 31-75 75-31q72 0 98 64h124q26-64 98-64t98 64h124q26-64 98-64z"></path>
                    </svg>
                  </div>
                </div>
                <svg viewBox="0 0 1024 1024" className="stats-quora-icon28">
                  <path d="M512 135.339l-273.664 273.664c-33.323 33.323-33.323 87.339 0 120.661s87.339 33.323 120.661 0l67.669-67.669v308.992c0 47.104 38.187 85.333 85.333 85.333 47.104 0 85.333-38.229 85.333-85.333v-308.992l67.669 67.669c16.683 16.683 38.485 25.003 60.331 25.003s43.648-8.32 60.331-25.003c33.323-33.323 33.323-87.339 0-120.661l-273.664-273.664z"></path>
                </svg>
              </div>
              <h1 className="stats-quora-text4">+ve</h1>
            </div>
          </div>
          <div className="stats-quora-container21">
            <h1 className="stats-quora-text5">Sentiment scale</h1>
          </div>
        </div>
        <div className="stats-quora-blog">
          <div className="stats-quora-container22">
            <BlogPostCard21
              text="😕"
              author="Ndtv"
          ...
          <div className="stats-quora-container23">
            <BlogPostCard21
              text="🙂"
          ...
          <BlogPostCard21
            ...
            description="Academic year! Don't miss out on the chance to join some of the best engineering colleges in the country. Apply now and take the first step towards your dream career! #EngineeringAdmissions #PrivateColleges #DreamBig"
      ...
      <style jsx>
        {`
          ...
          .stats-quora-container03 {
            flex: 0 0 auto;
            width: 100%;
            display: flex;
            align-items: flex-start;
          }
          .stats-quora-container04 {
            flex: 0 0 auto;
            width: 100%;
            height: auto;
            display: flex;
