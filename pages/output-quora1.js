...
const OutputQuora1 = (props) => {
  return (
    <>
      <div className="output-quora1-container">
        <Head>
          <title>OutputQuora1 - cyberX</title>
          <meta property="og:title" content="OutputQuora1 - cyberX" />
        </Head>
        <Header></Header>
        <div className="output-quora1-container01">
          <h1 className="output-quora1-text">Posts and Media</h1>
          <div
            data-thq="thq-dropdown"
            className="output-quora1-thq-dropdown list-item"
          >
            <ul
              data-thq="thq-dropdown-list"
              className="output-quora1-dropdown-list"
            >
              <li
                data-thq="thq-dropdown"
                className="output-quora1-dropdown list-item"
              >
                <div
                  data-thq="thq-dropdown-toggle"
                  className="output-quora1-dropdown-toggle"
                >
                  <span className="output-quora1-text1">Sub-menu Item</span>
                </div>
              </li>
              <li
                data-thq="thq-dropdown"
                className="output-quora1-dropdown1 list-item"
              >
                <div
                  data-thq="thq-dropdown-toggle"
                  className="output-quora1-dropdown-toggle1"
                >
                  <span className="output-quora1-text2">Sub-menu Item</span>
                </div>
              </li>
              <li
                data-thq="thq-dropdown"
                className="output-quora1-dropdown2 list-item"
              >
                <div
                  data-thq="thq-dropdown-toggle"
                  className="output-quora1-dropdown-toggle2"
                >
                  <span className="output-quora1-text3">Sub-menu Item</span>
                </div>
              </li>
            </ul>
          </div>
          <div className="output-quora1-container02">
            <div className="output-quora1-container03">
              <svg viewBox="0 0 1024 1024" className="output-quora1-icon">
              ...
              <span className="output-quora1-text4">Instagram</span>
            </div>
            <div className="output-quora1-container04">
              <svg viewBox="0 0 1024 1024" className="output-quora1-icon04">
                <path d="M1013.8 307.2c0 0-10-70.6-40.8-101.6-39-40.8-82.6-41-102.6-43.4-143.2-10.4-358.2-10.4-358.2-10.4h-0.4c0 0-215 0-358.2 10.4-20 2.4-63.6 2.6-102.6 43.4-30.8 31-40.6 101.6-40.6 101.6s-10.2 82.8-10.2 165.8v77.6c0 82.8 10.2 165.8 10.2 165.8s10 70.6 40.6 101.6c39 40.8 90.2 39.4 113 43.8 82 7.8 348.2 10.2 348.2 10.2s215.2-0.4 358.4-10.6c20-2.4 63.6-2.6 102.6-43.4 30.8-31 40.8-101.6 40.8-101.6s10.2-82.8 10.2-165.8v-77.6c-0.2-82.8-10.4-165.8-10.4-165.8zM406.2 644.8v-287.8l276.6 144.4-276.6 143.4z"></path>
              </svg>
              <span className="output-quora1-text5">YouTube</span>
            </div>
            <div className="output-quora1-container05">
              <svg viewBox="0 0 1024 1024" className="output-quora1-icon06">
                <path d="M1024 226.4c-37.6 16.8-78.2 28-120.6 33 43.4-26 76.6-67.2 92.4-116.2-40.6 24-85.6 41.6-133.4 51-38.4-40.8-93-66.2-153.4-66.2-116 0-210 94-210 210 0 16.4 1.8 32.4 5.4 47.8-174.6-8.8-329.4-92.4-433-219.6-18 31-28.4 67.2-28.4 105.6 0 72.8 37 137.2 93.4 174.8-34.4-1-66.8-10.6-95.2-26.2 0 0.8 0 1.8 0 2.6 0 101.8 72.4 186.8 168.6 206-17.6 4.8-36.2 7.4-55.4 7.4-13.6 0-26.6-1.4-39.6-3.8 26.8 83.4 104.4 144.2 196.2 146-72 56.4-162.4 90-261 90-17 0-33.6-1-50.2-3 93.2 59.8 203.6 94.4 322.2 94.4 386.4 0 597.8-320.2 597.8-597.8 0-9.2-0.2-18.2-0.6-27.2 41-29.4 76.6-66.4 104.8-108.6z"></path>
              </svg>
              <span className="output-quora1-text6">Twitter</span>
            </div>
            <div className="output-quora1-container06">
              <svg
                viewBox="0 0 1027.4377142857143 1024"
                className="output-quora1-icon08"
              >
              ...
              <span className="output-quora1-text7">Quora</span>
            </div>
          </div>
        </div>
        <div className="output-quora1-container07">
          <Link href="/stats-twitter">
            <a className="output-quora1-link button">
              <span className="output-quora1-text8">View Stats</span>
              <svg
                viewBox="0 0 1170.2857142857142 1024"
                className="output-quora1-icon10"
              >
        ...
        <div className="output-quora1-blog">
          <div className="output-quora1-container08">
            <BlogPostCard2
              when="10 minutes ago"
              label="Educational"
          ...
          <div className="output-quora1-container09">
            <BlogPostCard2
              when="16 minutes ago"
              label="JOBS"
        ...
        <div className="output-quora1-blog1">
          <div className="output-quora1-container10">
            <BlogPostCard2
              when="20 minutes ago"
              label="Educational"
              title="Fee hike an issue says Student"
          ...
          <div className="output-quora1-container11">
            <BlogPostCard2
              when="35 minutes ago"
              label="JOBS"
              title="Is AI really a Job Killer?"
      ...
      <style jsx>
        {`
          ...
          .output-quora1-thq-dropdown {
            cursor: pointer;
            display: inline-block;
            position: relative;
            border-radius: var(--dl-radius-radius-radius2);
          }
          .output-quora1-dropdown-list {
            left: 0%;
            width: max-content;
            display: none;
            z-index: 100;
          ...
          .output-quora1-dropdown {
            cursor: pointer;
            display: inline-block;
            position: relative;
            border-radius: var(--dl-radius-radius-radius2);
          }
          .output-quora1-dropdown-toggle {
            fill: #595959;
            color: #595959;
            width: 100%;
            display: inline-flex;
          ...
          .output-quora1-dropdown-toggle:hover {
            fill: #fff;
            color: #fff;
          ...
          .output-quora1-dropdown1 {
            cursor: pointer;
            display: inline-block;
            position: relative;
            border-radius: var(--dl-radius-radius-radius2);
          }
          .output-quora1-dropdown-toggle1 {
            fill: #595959;
            color: #595959;
            width: 100%;
            display: inline-flex;
          ...
          .output-quora1-dropdown-toggle1:hover {
            fill: #fff;
            color: #fff;
            background-color: #595959;
          }
          ...
          .output-quora1-dropdown2 {
            cursor: pointer;
            display: inline-block;
            position: relative;
            border-radius: var(--dl-radius-radius-radius2);
          }
          .output-quora1-dropdown-toggle2 {
            fill: #595959;
            color: #595959;
            width: 100%;
            display: inline-flex;
          ...
          .output-quora1-dropdown-toggle2:hover {
            fill: #fff;
            color: #fff;
            background-color: #595959;
          }
