  ...
  return (
    <>
      <div className="component11-container">
        <h1 className="component11-text">{props.heading}</h1>
        <div
          data-thq="thq-dropdown"
          className="component11-thq-dropdown list-item"
        >
          <ul
            data-thq="thq-dropdown-list"
            className="component11-dropdown-list"
          >
            <li
              data-thq="thq-dropdown"
              className="component11-dropdown list-item"
            >
              <div
                data-thq="thq-dropdown-toggle"
                className="component11-dropdown-toggle"
              >
            ...
            <li
              data-thq="thq-dropdown"
              className="component11-dropdown1 list-item"
            >
              <div
                data-thq="thq-dropdown-toggle"
                className="component11-dropdown-toggle1"
              >
                <span className="component11-text2">{props.text1}</span>
              </div>
            </li>
            <li
              data-thq="thq-dropdown"
              className="component11-dropdown2 list-item"
            >
              <div
                data-thq="thq-dropdown-toggle"
                className="component11-dropdown-toggle2"
              >
                <span className="component11-text3">{props.text2}</span>
              </div>
            </li>
          </ul>
        </div>
        <div className="component11-container1">
          ...
          <div className="component11-container3">
            ...
            <span className="component11-text5">{props.text41}</span>
          </div>
          <div className="component11-container4">
            ...
            <span className="component11-text6">{props.text42}</span>
          </div>
          <div className="component11-container5">
            <svg
              viewBox="0 0 1027.4377142857143 1024"
              className="component11-icon08"
            >
            ...
            <span className="component11-text7">{props.text43}</span>
          </div>
        </div>
      </div>
      <style jsx>
        {`
          .component11-container {
            flex: 0 0 auto;
            width: 100%;
            display: flex;
            position: relative;
          ...
          .component11-thq-dropdown {
            cursor: pointer;
            display: inline-block;
            position: relative;
            border-radius: var(--dl-radius-radius-radius2);
          }
          .component11-dropdown-list {
            left: 0%;
            width: max-content;
            display: none;
            z-index: 100;
          ...
          .component11-dropdown {
            cursor: pointer;
            display: inline-block;
            position: relative;
            border-radius: var(--dl-radius-radius-radius2);
          }
          .component11-dropdown-toggle {
            fill: #595959;
            color: #595959;
            width: 100%;
            display: inline-flex;
          ...
          .component11-dropdown-toggle:hover {
            fill: #fff;
            color: #fff;
          ...
          .component11-dropdown1 {
            cursor: pointer;
            display: inline-block;
            position: relative;
            border-radius: var(--dl-radius-radius-radius2);
          }
          .component11-dropdown-toggle1 {
            fill: #595959;
            color: #595959;
            width: 100%;
            display: inline-flex;
          ...
          .component11-dropdown-toggle1:hover {
            fill: #fff;
            color: #fff;
            background-color: #595959;
          }
          ...
          .component11-dropdown2 {
            cursor: pointer;
            display: inline-block;
            position: relative;
            border-radius: var(--dl-radius-radius-radius2);
          }
          .component11-dropdown-toggle2 {
            fill: #595959;
            color: #595959;
            width: 100%;
            display: inline-flex;
          ...
          .component11-dropdown-toggle2:hover {
            fill: #fff;
            color: #fff;
            background-color: #595959;
          }
