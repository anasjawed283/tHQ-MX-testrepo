    ...
    <>
      <div className={`component1-container ${props.rootClassName} `}>
        ...
        <div
          ...
          className="component1-thq-dropdown list-item"
        >
          <ul data-thq="thq-dropdown-list" className="component1-dropdown-list">
            <li
              data-thq="thq-dropdown"
              className="component1-dropdown list-item"
            >
              <div
                data-thq="thq-dropdown-toggle"
                className="component1-dropdown-toggle"
              >
            ...
            <li
              data-thq="thq-dropdown"
              className="component1-dropdown1 list-item"
            >
              <div
                data-thq="thq-dropdown-toggle"
                className="component1-dropdown-toggle1"
              >
            ...
            <li
              data-thq="thq-dropdown"
              className="component1-dropdown2 list-item"
            >
              <div
                data-thq="thq-dropdown-toggle"
                className="component1-dropdown-toggle2"
              >
                <span className="component1-text3">{props.text2}</span>
              </div>
            </li>
          </ul>
        </div>
        <div className="component1-container1">
          <div className="component1-container2">
            ...
            <span className="component1-text4">{props.text4}</span>
          </div>
          <div className="component1-container3">
            ...
            <span className="component1-text5">{props.text41}</span>
          </div>
          <div className="component1-container4">
            ...
            <span className="component1-text6">{props.text42}</span>
          </div>
          <div className="component1-container5">
            <svg
              viewBox="0 0 1027.4377142857143 1024"
              className="component1-icon08"
            >
            ...
            <span className="component1-text7">{props.text43}</span>
          </div>
        </div>
      </div>
      <style jsx>
        {`
          ...
          .component1-thq-dropdown {
            cursor: pointer;
            display: inline-block;
            position: relative;
            border-radius: var(--dl-radius-radius-radius2);
          }
          .component1-dropdown-list {
            left: 0%;
            width: max-content;
            display: none;
            z-index: 100;
          ...
          .component1-dropdown-toggle:hover {
            fill: #fff;
            color: #fff;
          ...
          .component1-dropdown1 {
            cursor: pointer;
            display: inline-block;
            position: relative;
            border-radius: var(--dl-radius-radius-radius2);
          }
          .component1-dropdown-toggle1 {
            fill: #595959;
            color: #595959;
            width: 100%;
            display: inline-flex;
          ...
          .component1-dropdown-toggle1:hover {
            fill: #fff;
            color: #fff;
            background-color: #595959;
          }
          ...
          .component1-dropdown2 {
            cursor: pointer;
            display: inline-block;
            position: relative;
            border-radius: var(--dl-radius-radius-radius2);
          }
          .component1-dropdown-toggle2 {
            fill: #595959;
            color: #595959;
            width: 100%;
            display: inline-flex;
          ...
          .component1-dropdown-toggle2:hover {
            fill: #fff;
            color: #fff;
            background-color: #595959;
          }
