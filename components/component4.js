    ...
    <>
      <div className="component4-container">
        <div className="component4-container1">
          ...
          <div
            ...
            className="component4-thq-dropdown list-item"
          >
            <ul
              data-thq="thq-dropdown-list"
              className="component4-dropdown-list"
            >
              <li
                data-thq="thq-dropdown"
                className="component4-dropdown list-item"
              >
                <div
                  data-thq="thq-dropdown-toggle"
                  className="component4-dropdown-toggle"
                >
              ...
              <li
                data-thq="thq-dropdown"
                className="component4-dropdown1 list-item"
              >
                <div
                  data-thq="thq-dropdown-toggle"
                  className="component4-dropdown-toggle1"
                >
                  <span className="component4-text2">{props.text1}</span>
                </div>
              </li>
              <li
                data-thq="thq-dropdown"
                className="component4-dropdown2 list-item"
              >
                <div
                  data-thq="thq-dropdown-toggle"
                  className="component4-dropdown-toggle2"
                >
                  <span className="component4-text3">{props.text2}</span>
                </div>
              </li>
            </ul>
          </div>
          <div className="component4-container2">
            <div className="component4-container3">
              <svg viewBox="0 0 1024 1024" className="component4-icon">
            ...
            <div className="component4-container6">
              ...
              <span className="component4-text7">{props.text43}</span>
            </div>
          </div>
        </div>
      </div>
      <style jsx>
        {`
          ...
          .component4-thq-dropdown {
            cursor: pointer;
            display: inline-block;
            position: relative;
            border-radius: var(--dl-radius-radius-radius2);
          }
          .component4-dropdown-list {
            left: 0%;
            width: max-content;
            display: none;
            z-index: 100;
          ...
          .component4-dropdown-toggle:hover {
            fill: #fff;
            color: #fff;
          ...
          .component4-dropdown1 {
            cursor: pointer;
            display: inline-block;
            position: relative;
            border-radius: var(--dl-radius-radius-radius2);
          }
          .component4-dropdown-toggle1 {
            fill: #595959;
            color: #595959;
            width: 100%;
            display: inline-flex;
          ...
          .component4-dropdown-toggle1:hover {
            fill: #fff;
            color: #fff;
            background-color: #595959;
          }
          ...
          .component4-dropdown2 {
            cursor: pointer;
            display: inline-block;
            position: relative;
            border-radius: var(--dl-radius-radius-radius2);
          }
          .component4-dropdown-toggle2 {
            fill: #595959;
            color: #595959;
            width: 100%;
            display: inline-flex;
          ...
          .component4-dropdown-toggle2:hover {
            fill: #fff;
            color: #fff;
            background-color: #595959;
          }
